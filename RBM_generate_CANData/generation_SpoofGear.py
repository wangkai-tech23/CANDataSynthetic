...
if __name__ == '__main__':
    ...
    choose_lines = 9000
    data = pd.read_csv("./car_hacking/csv/chuli/spoofing_the_drive_gear_ttt_2.csv",
    ...
    with open('./gen_data_rbm/another_gen_spoof_gear_ttt.csv', 'w', newline='') as file:
    ...
    with open('p_jz.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        lll_list = np.arange(0, r.num_hidden, 1)
        writer.writerow(lll_list)
        writer.writerows(r.weights)
